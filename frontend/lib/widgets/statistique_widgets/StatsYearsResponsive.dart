...
class StatsBYYresponsiveWidget extends StatefulWidget {
  @override
  _StatsBYYresponsiveWidgetState createState() => _StatsBYYresponsiveWidgetState();
}

class _StatsBYYresponsiveWidgetState extends State<StatsBYYresponsiveWidget> {
                                              ...
                                              Container(
                                                ...
                                                child: CustomPaint(
                                                  painter: BarChartPainter(
                                                    barValues: [105, 150, 203, 270, 290, 340, 380, 400, 450, 460],
                                                    gradientColors: gradientColors,
                                                    minValue: 0,
                                                    maxValue: 500,
                                                    bottomTitles: ['2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023'],
                                                    leftTitles: ['0','100', '200', '300' , '400' , '500'],
                                                  ),
                                                ),
                                              ),
                                              Positioned(
...
class BarChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < barValues.length; i++) {
      final barHeight = (barValues[i] - minValue) / (maxValue - minValue) * maxBarHeight;

      final rect = Rect.fromLTRB(
        i * barWidth + barWidth / 4 + 20, // Adjust bar spacing here
        size.height - barHeight - 60,
        (i + 1) * barWidth - barWidth / 4 + 20, // Adjust bar spacing here
        size.height - 60,
      );
      ...
      xTitlePainter.paint(canvas, Offset(xTitleX - xTitlePainter.width / 2, xTitleY));
    }
    ...
    for (int i = 0; i < leftTitles.length; i++) {
      ...
      horizontalLineTitlePainter.paint(canvas, Offset(horizontalLineTitleX, horizontalLineTitleY));
    }
